...
echo "" >> ../conf/messages
echo "childAgedTwo.title = childAgedTwo" >> ../conf/messages
echo "childAgedTwo.heading = childAgedTwo" >> ../conf/messages
echo "childAgedTwo.checkYourAnswersLabel = childAgedTwo" >> ../conf/messages
