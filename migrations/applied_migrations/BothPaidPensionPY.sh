...
echo "" >> ../conf/messages
echo "bothPaidPensionPY.title = bothPaidPensionPY" >> ../conf/messages
echo "bothPaidPensionPY.heading = bothPaidPensionPY" >> ../conf/messages
echo "bothPaidPensionPY.checkYourAnswersLabel = bothPaidPensionPY" >> ../conf/messages
