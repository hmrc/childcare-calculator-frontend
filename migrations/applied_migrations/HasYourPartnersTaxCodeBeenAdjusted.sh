...
awk '/class/ {\
     print;\
     print "  def hasYourPartnersTaxCodeBeenAdjusted: Option[Boolean] = cacheMap.getEntry[Boolean](HasYourPartnersTaxCodeBeenAdjustedId.toString)";\
     print "";\
...
awk '/class/ {\
     ...
     print "    x => AnswerRow(\"hasYourPartnersTaxCodeBeenAdjusted.checkYourAnswersLabel\", if(x) \"site.yes\" else \"site.no\", true, routes.HasYourPartnersTaxCodeBeenAdjustedController.onPageLoad(CheckMode).url)"; print "  }";\
