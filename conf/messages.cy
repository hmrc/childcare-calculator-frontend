...
results.firstParagraph.youToldTheCalculatorThat=Gwnaethoch ateb:
results.firstParagraph.youToldTheCalculator={0} {1}
...
results.firstParagraph.yearlyChildcareCosts=bod gennych gostau gofal plant blynyddol o tua £
results.firstParagraph.withYourPartner=gyda’ch partner
results.firstParagraph.onYourOwn=ar eich pen eich hun
results.firstParagraph.youLiveAnd=eich bod yn byw {0}

results.firstParagraph.youInPaidWork = rydych yn gweithio am dâl
results.firstParagraph.onlyYouInPaidWork = rydych yn gweithio am dâl, ond nid yw’ch partner yn gweithio am dâl
results.firstParagraph.youAndPartnerInPaidWork = eich bod chi a’ch partner yn gweithio am dâl ar hyn o bryd
results.firstParagraph.onlyPartnerInPaidWork = mae’ch partner yn gweithio am dâl, ond nid ydych chi’n yn gweithio am dâl
results.firstParagraph.neitherInPaidWork = nid oes unrhyw un ohonoch yn gweithio am dâl ar hyn o bryd
results.firstParagraph.youWorkXHoursAweek = eich bod yn gweithio {0} awr yr wythnos
results.firstParagraph.yourPartnerWorksXHoursAweek = bod eich partner yn gweithio {0} awr yr wythnos
...
childStartEducation.title=Pryd y dechreuodd eich plentyn eu haddysg neu ei hyfforddiant?
childStartEducation.heading=Pryd y dechreuodd {0} yn eu haddysg neu hyfforddiant?
childStartEducation.hint=Er enghraifft, 31 3 2015
childStartEducation.checkYourAnswersLabel=Pryd y dechreuodd eich plentyn eu haddysg neu ei hyfforddiant?
childStartEducation.error.required = Nodwch y dyddiad y dechreuodd {0} yn eu haddysg neu eu hyfforddiant
...
result.schemes.tfc.ineligibility.vouchers.guidance.bullet.livesAlone=ni ellir defnyddio Gofal Plant sy’n Rhydd o Dreth gyda thalebau gofal plant
...
result.free.hours.period.england=o ofal plant yn rhad ac am ddim yr wythnos - mae hyn yn {0} o oriau y flwyddyn.
...
result.free.childcare.working.parents.not.eligible.paidEmployment = Mae angen i chi fod yn gweithio am dâl er mwyn cael Gofal Plant yn Rhad ac am Ddim i Rieni sy’n Gweithio.
...
result.free.childcare.working.parents.not.eligible.noCosts = Nid oes gennych unrhyw gostau gofal plant ac nid ydych yn disgwyl y bydd gennych rai, felly ni allwch gael Gofal Plant sy’n Rhad ac am Ddim i Rieni sy’n Gweithio.

result.tfc.title = Gofal Plant sy’n Rhydd o Dreth
result.tfc.warning.tc.esc = Os bydd eich cais i gael Gofal Plant sy’n Rhydd o Dreth yn llwyddiannus, ni fyddwch yn gallu cael talebau gofal plant na chredydau treth ar yr un pryd.
result.tfc.warning.tc = Os bydd eich cais i gael Gofal Plant sy’n Rhydd o Dreth yn llwyddiannus, ni fyddwch yn gallu cael chredydau treth ar yr un pryd.
result.tfc.warning.esc = Os bydd eich cais i gael Gofal Plant sy’n Rhydd o Dreth yn llwyddiannus, ni fyddwch yn gallu cael talebau gofal plant ar yr un pryd.
result.tfc.warning.uc = Bydd eich Credyd Cynhwysol yn dod i ben os byddwch yn gwneud cais am Ofal Plant sy’n Rhydd o Dreth.
result.tfc.period = y flwyddyn tuag at eich costau gofal plant.
result.tfc.not.eligible.partner.paidEmployment = Mae angen i chi a’ch partner fod yn gweithio am dâl er mwyn cael Gofal Plant sy’n Rhydd o Dreth.
result.tfc.not.eligible.partner.minimumEarning.sameAge = Mae angen i chi a’ch partner fod yn gweithio am dâl ac yn ennill o leiaf £{0} yr wythnos er mwyn cael Gofal Plant sy’n Rhydd o Dreth.
result.tfc.not.eligible.partner.minimumEarning.differentAge = Mae angen i chi fod yn gweithio am dâl ac yn ennill o leiaf £{0} yr wythnos, ac mae angen i’ch partner fod yn gweithio am dâl ac yn ennill o leiaf £{1} yr wythnos, er mwyn cael Gofal Plant sy’n Rhydd o Dreth.
result.tfc.not.eligible.partner.maximumEarning = *WELSH PENDING*
result.tfc.not.eligible.paidEmployment = Mae angen i chi fod yn gweithio am dâl er mwyn cael Gofal Plant sy’n Rhydd o Dreth.
result.tfc.not.eligible.minimumEarning = Mae angen i chi fod yn gweithio am dâl ac yn ennill o leiaf £{0} yr wythnos er mwyn cael Gofal Plant sy’n Rhydd o Dreth.
result.tfc.not.eligible.maximumEarning = Mae angen i chi fod yn ennill llai na £100,000 y flwyddyn fel incwm net wedi’i addasu er mwyn cael Gofal Plant sy’n Rhydd o Dreth.
result.tfc.not.eligible.noCosts = Nid oes gennych unrhyw gostau gofal plant ac nid ydych yn disgwyl y bydd gennych rai, felly ni allwch gael Gofal Plant sy’n Rhydd o Dreth.
result.tfc.not.eligible.age = Nid yw plant yn gymwys o 1 Medi ar ôl eu pen-blwydd yn 11 oed, nac ar ôl eu pen-blwydd yn 16 oed os ydyn nhw’n anabl.
...
aboutYourResults.free.childcare.hours.para2=Gallwch chi defnyddio eich oriau am ddim rhwng 2 ddarparwr cymeradwy gwahanol. Er enghraifft, gwarchodwr plant cofrestredig, cynllun chwarae, meithrinfa, clwb y tu allan i’r ysgol neu weithiwr gofal cartref sy’n gweithio i asiantaeth gofrestredig. Efallai y byddan nhw’n codi tâl am wasanaethau ychwanegol.
...
aboutYourResults.more.info.england.hours.title=Gwneud cais am Ofal Plant sy'n Rhad ac am Ddim i Rieni sy'n Gweithio
...
aboutYourResults.more.info.england.tfc.title = Gwneud cais am Ofal Plant sy’n Rhydd o Dreth
...
results.two.years.old.guidance.england.link.text=efallai y byddwch yn gallu cael 15 awr o ofal plant yn rhad ac am ddim yr wythnos ar gyfer eich plentyn 2 oed
