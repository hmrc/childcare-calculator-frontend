...
import uk.gov.hmrc.childcarecalculatorfrontend.utils.ChildcareConstants.parentPaidWorkPYErrorKey
...
class ParentPaidWorkPYController @Inject()(appConfig: FrontendAppConfig,
                                           ...
                                           parentPaidWorkPY: parentPaidWorkPY)(implicit ec: ExecutionContext)
  extends FrontendController(mcc)with I18nSupport {

  def onPageLoad(mode: Mode): Action[AnyContent] = (getData andThen requireData) {
    implicit request =>
      val preparedForm = request.userAnswers.parentPaidWorkPY match {
