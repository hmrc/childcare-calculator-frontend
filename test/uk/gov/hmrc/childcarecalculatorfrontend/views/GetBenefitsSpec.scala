...
class GetBenefitsSpec extends TemplatesValidator with FakeCCApplication {
  ...
  override val contentData: List[ElementDetails] = List(
    ...
    ElementDetails(id = Some("get-benefits-para"), tagName = Some("li"), tagIndex = Some(0), value = applicationMessages.messages(s"get.benefits.para.list1")),
    ElementDetails(id = Some("get-benefits-para"), tagName = Some("li"), tagIndex = Some(1), value = applicationMessages.messages(s"get.benefits.para.list2")),
    ElementDetails(id = Some("get-benefits-para"), tagName = Some("li"), tagIndex = Some(2), value = applicationMessages.messages(s"get.benefits.para.list3")),
    ElementDetails(id = Some("get-benefits-para"), tagName = Some("li"), tagIndex = Some(3), value = applicationMessages.messages(s"get.benefits.para.list4")),
    ElementDetails(id = Some("get-benefits-para"), tagName = Some("li"), tagIndex = Some(4), value = applicationMessages.messages(s"get.benefits.para.list5")),
    ElementDetails(id = Some("get-benefits-para"), tagName = Some("li"), tagIndex = Some(5), value = applicationMessages.messages(s"get.benefits.para.list6")),
    ElementDetails(id = Some("get-benefits-para"), tagName = Some("li"), tagIndex = Some(6), value = applicationMessages.messages(s"get.benefits.para.list7")),
    ElementDetails(id = Some("get-benefits-para"), tagName = Some("li"), tagIndex = Some(7), value = applicationMessages.messages(s"get.benefits.para.list8")),
