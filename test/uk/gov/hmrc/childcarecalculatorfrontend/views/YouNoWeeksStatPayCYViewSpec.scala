...
class YouNoWeeksStatPayCYViewSpec extends IntViewBehaviours {
  ...
  "YouNoWeeksStatPayCY view" must {
    ...
    behave like intPage(createViewUsingForm, messageKeyPrefix, routes.YouNoWeeksStatPayCYController.onSubmit(NormalMode).url)
  }
}
