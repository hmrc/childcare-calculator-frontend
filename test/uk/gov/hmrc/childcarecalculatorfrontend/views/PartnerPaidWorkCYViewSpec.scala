...
class PartnerPaidWorkCYViewSpec extends YesNoViewBehaviours {
  ...
  def createView = () => partnerPaidWorkCY(frontendAppConfig, BooleanForm(), NormalMode)(fakeRequest, messages)

  def createViewUsingForm = (form: Form[Boolean]) => partnerPaidWorkCY(frontendAppConfig, form, NormalMode)(fakeRequest, messages)
