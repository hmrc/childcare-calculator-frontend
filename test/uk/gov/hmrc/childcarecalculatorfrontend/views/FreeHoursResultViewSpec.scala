...
class FreeHoursResultViewSpec extends ViewBehaviours {
  ...
  def createView = () => freeHoursResult(frontendAppConfig, LocationEnum.ENGLAND, NotEligible, Seq())(fakeRequest, messages)

  def createViewWithAnswers = (location: LocationEnum.Value,
  ...
  "FreeHoursResult view" when {
    "rendered" must {
      "contain correct guidance when not eligible for location other than northern-ireland" in {
        ...
        val doc = asDocument(createViewWithAnswers(LocationEnum.ENGLAND, NotEligible, answerSections))
      ...
      "contain correct guidance when not eligible for location northern-ireland" in {
        ...
        val doc = asDocument(createViewWithAnswers(LocationEnum.NORTHERN_IRELAND, NotEligible, answerSections))
      ...
      "eligible for 16 free hours for scotland and not eligible for other schemes" in {
        ...
        val doc = asDocument(createViewWithAnswers(LocationEnum.SCOTLAND, Eligible, Seq()))
      ...
      "eligible for 10 free hours for wales and not eligible for other schemes" in {
        ...
        val doc = asDocument(createViewWithAnswers(LocationEnum.WALES, Eligible, Seq()))
      ...
      "eligible for 12.5 free hours for northern-ireland and not eligible for other schemes" in {
        ...
        val doc = asDocument(createViewWithAnswers(LocationEnum.NORTHERN_IRELAND, Eligible, Seq()))
