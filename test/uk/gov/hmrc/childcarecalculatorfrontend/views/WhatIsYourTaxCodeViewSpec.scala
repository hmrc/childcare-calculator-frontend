...
class WhatIsYourTaxCodeViewSpec extends IntViewBehaviours {
  ...
  def createViewUsingForm = (form: Form[Int]) => whatIsYourTaxCode(frontendAppConfig, form, NormalMode)(fakeRequest, messages)

  val form = WhatIsYourTaxCodeForm()
