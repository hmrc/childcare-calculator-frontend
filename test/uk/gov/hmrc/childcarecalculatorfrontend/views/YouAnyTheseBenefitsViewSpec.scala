...
class YouAnyTheseBenefitsViewSpec extends YesNoViewBehaviours {

  val messageKeyPrefix = "youAnyTheseBenefitsCY"

  def createView = () => youAnyTheseBenefitsCY(frontendAppConfig, BooleanForm(), NormalMode)(fakeRequest, messages)

  def createViewUsingForm = (form: Form[Boolean]) => youAnyTheseBenefitsCY(frontendAppConfig, form, NormalMode)(fakeRequest, messages)
