...
class YouPaidPensionPYViewSpec extends NewYesNoViewBehaviours {
  ...
  "YouPaidPensionPY view" must {
    ...
    behave like yesNoPage(createViewUsingForm, messageKeyPrefix, routes.YouPaidPensionPYController.onSubmit(NormalMode).url)
  }
}
