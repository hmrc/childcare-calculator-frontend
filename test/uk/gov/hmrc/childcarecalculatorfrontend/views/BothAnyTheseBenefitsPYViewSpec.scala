...
class BothAnyTheseBenefitsPYViewSpec extends NewYesNoViewBehaviours {
  ...
  "BothAnyTheseBenefitsPY view for non scottish users" must {
    ...
    behave like yesNoPage(createViewUsingForm(location:Location.Value), messageKeyPrefix, routes.BothAnyTheseBenefitsPYController.onSubmit(NormalMode).url)
  ...
  "BothAnyTheseBenefitsPY view for scottish users" must {
