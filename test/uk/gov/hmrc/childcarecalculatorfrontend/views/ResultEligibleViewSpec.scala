  ...
  "Result eligible view" must {
    ...
    "Contain results" when {
      "We have free hours value" in {
        ...
        val view = asDocument(appResultEligible(model, utils, hideTC = false, "england")(messages))
      ...
      "User is eligible for TC scheme" in {
        ...
        val viewWithLessThan1000 = asDocument(appResultEligible(modelWithLessThan1000, utils, hideTC = false, "england")(messages))
        val viewWithMoreThan1000 = asDocument(appResultEligible(modelWithMoreThan1000, utils, hideTC = false, "england")(messages))
    ...
    "display correct no of free hours and text when user is eligible for free hours" when {
      ...
      "location is Wales" in {
        ...
        val view = asDocument(appResultEligible(model, utils, hideTC = false, "wales")(messages))
      ...
      "location is Scotland" in {
        ...
        val view = asDocument(appResultEligible(model, utils, hideTC = false, "scotland")(messages))
      ...
      "location is NI" in {
        ...
        val view = asDocument(appResultEligible(model, utils, hideTC = false, "northern-ireland")(messages))
