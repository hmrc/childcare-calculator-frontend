  ...
  "Result eligible view" must {
    ...
    "Contain results" when {
      "We have free hours value" in {
        ...
        val view = asDocument(appResultEligible(model, utils, hideTC = false)(fakeRequest, messages))
      ...
      "User is eligible for TC scheme" in {
        ...
        val viewWithLessThan1000 = asDocument(appResultEligible(modelWithLessThan1000, utils, hideTC = false)(fakeRequest, messages))
        val viewWithMoreThan1000 = asDocument(appResultEligible(modelWithMoreThan1000, utils, hideTC = false)(fakeRequest, messages))
