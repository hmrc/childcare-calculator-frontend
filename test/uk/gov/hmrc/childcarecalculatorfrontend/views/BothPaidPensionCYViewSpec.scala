...
class BothPaidPensionCYViewSpec extends YesNoViewBehaviours {
  ...
  def createView = () => bothPaidPensionCY(frontendAppConfig, BooleanForm(), NormalMode)(fakeRequest, messages)

  def createViewUsingForm = (form: Form[Boolean]) => bothPaidPensionCY(frontendAppConfig, form, NormalMode)(fakeRequest, messages)
