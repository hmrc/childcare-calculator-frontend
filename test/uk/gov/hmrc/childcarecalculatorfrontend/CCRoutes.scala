...
trait CCRoutes {
  ...
  val parentMaximumEarningsPath: String = path("/minimum-earnings/parent")
  val partnerMaximumEarningsPath: String = path("/minimum-earnings/partner")
  val bothMaximumEarningsPath: String = path("/minimum-earnings/partner")
