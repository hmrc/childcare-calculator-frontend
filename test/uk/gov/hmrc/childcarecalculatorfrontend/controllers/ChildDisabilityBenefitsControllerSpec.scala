...
import uk.gov.hmrc.childcarecalculatorfrontend.identifiers.ChildDisabilityBenefitsId
import uk.gov.hmrc.childcarecalculatorfrontend.models.NormalMode
import uk.gov.hmrc.childcarecalculatorfrontend.views.html.childDisabilityBenefits

class ChildDisabilityBenefitsControllerSpec extends ControllerSpecBase {
  ...
  "ChildDisabilityBenefits Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      val validData = Map(ChildDisabilityBenefitsId.toString -> JsBoolean(true))
    ...
    "return a Bad Request and errors when invalid data is submitted" in {
      ...
      val boundForm = BooleanForm("childDisabilityBenefits.error").bind(Map("value" -> "invalid value"))
