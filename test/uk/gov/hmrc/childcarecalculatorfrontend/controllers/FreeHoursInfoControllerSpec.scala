...
class FreeHoursInfoControllerSpec extends ControllerSpecBase {
  ...
  "FreeHoursInfo Controller" must {
    ...
    "return OK with childcare vouchers, tfc when we have childcare costs and they are approved" in {
      val location = ENGLAND
    ...
    "return OK with no childcare vouchers, tfc when we don't have childcare costs" when {
