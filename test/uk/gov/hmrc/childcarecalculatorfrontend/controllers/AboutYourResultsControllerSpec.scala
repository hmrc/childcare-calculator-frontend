...
class AboutYourResultsControllerSpec extends ControllerSpecBase with MockitoSugar{
  ...
  "AboutYourResults Controller" must {
    "return OK and the correct view for a GET" in {
      val model = ResultsViewModel(location = Location.ENGLAND, hasChildcareCosts = true, hasCostsWithApprovedProvider = true, isAnyoneInPaidEmployment = true, livesWithPartner = true)
