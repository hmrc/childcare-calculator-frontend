...
class RegisteredBlindControllerSpec extends ControllerSpecBase {
  ...
  def viewAsString(form: Form[Boolean] = BooleanForm()) = registeredBlind(frontendAppConfig, form, NormalMode)(fakeRequest, messages).toString
  ...
  "RegisteredBlind Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      val validData = Map(RegisteredBlindId.toString -> JsBoolean(true))
