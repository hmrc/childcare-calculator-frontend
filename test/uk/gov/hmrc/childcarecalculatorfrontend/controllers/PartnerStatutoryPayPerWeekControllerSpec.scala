...
class PartnerStatutoryPayPerWeekControllerSpec extends ControllerSpecBase {
  ...
  def viewAsString(form: Form[Int] = PartnerStatutoryPayPerWeekForm()) = partnerStatutoryPayPerWeek(frontendAppConfig, form, NormalMode)(fakeRequest, messages).toString
  ...
  "PartnerStatutoryPayPerWeek Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      val validData = Map(PartnerStatutoryPayPerWeekId.toString -> JsNumber(testNumber))
