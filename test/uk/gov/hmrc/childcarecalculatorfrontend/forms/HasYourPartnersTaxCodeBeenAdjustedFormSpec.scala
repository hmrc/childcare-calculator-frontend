...
class HasYourPartnersTaxCodeBeenAdjustedFormSpec extends FormBehaviours {

  val validData: Map[String, String] = Map(
    "value" -> HasYourPartnersTaxCodeBeenAdjustedForm.options.head.value
  )

  val form = HasYourPartnersTaxCodeBeenAdjustedForm()
