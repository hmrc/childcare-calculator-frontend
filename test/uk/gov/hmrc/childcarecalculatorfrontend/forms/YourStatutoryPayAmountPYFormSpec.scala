...
class YourStatutoryPayAmountPYFormSpec extends FormSpec {

  val statutoryForm = new YourStatutoryPayAmountPYForm(frontendAppConfig).apply()

  val errorKeyBlank = "parentStatutoryPayAmountPY.required"
  val errorKeyInvalid = "parentStatutoryPayAmountPY.invalid"

  "YourStatutoryPayAmountPY Form" must {
