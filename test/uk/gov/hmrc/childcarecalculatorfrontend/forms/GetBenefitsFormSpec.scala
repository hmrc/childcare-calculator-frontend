...
class GetBenefitsFormSpec extends UnitSpec with FakeCCApplication {

  val testCases = Table(
    ("Has partner", "Error message key"),
    (false, "get.benefits.not.selected.error.single"),
    (true, "get.benefits.not.selected.error.couple")
  )

  "GetBenefitsForm" when {
